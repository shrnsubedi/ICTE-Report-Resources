...
This project analyzes and compares the energy usage of different MQTT brokers as part of the ICTE (ICT for Energy) course. The goal is to assess the efficiency of lightweight communication protocols commonly used in IoT, with a focus on their energy profiles under various workloads.
